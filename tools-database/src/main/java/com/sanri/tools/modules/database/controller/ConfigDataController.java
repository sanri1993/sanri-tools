...
public class ConfigDataController {
    ...
    @GetMapping("/dataIds")
    public List<String> dataIds(String connName,String schemaName,String groupId) throws SQLException, IOException {
        return configDataService.dataIds(connName,schemaName,groupId);
    }

    @GetMapping("/content")
    public String content(String connName,String schemaName,String groupId,String dataId) throws SQLException, IOException {
